    ...
    <section style={{ background: "#F7F9FC", padding: "80px 0" }}>
      <div style={{ maxWidth: 1100, margin: "0 auto", padding: "0 24px" }}>
        <div style={{ textAlign: "center", marginBottom: 48 }}>
          ...
          <h2 style={{ fontSize: 36, fontWeight: 800, color: "#142033", margin: "0 0 16px", letterSpacing: "-0.5px" }}>Gestionar el cumplimiento sin las herramientas adecuadas tiene un coste real</h2>
          <p style={{ fontSize: 18, color: "#5E6B7A", maxWidth: 580, margin: "0 auto", lineHeight: 1.65 }}>La mayoría de empresas certificadas gestionan sus sistemas en hojas de cálculo, correos y carpetas compartidas.</p>
        </div>
