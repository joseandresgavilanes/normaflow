...
const METRIC_STYLES = [
  ...
  { match: /proveedor|socio|tercero|personal|usuario/i, Icon: Handshake, color: "var(--nf-primary-active)", background: "#f5efff" },
  ...
  { match: /fuente|revisi|traza|seguimiento/i, Icon: Search, color: "#475569", background: "var(--nf-surface-muted)" },
  { match: /person|humana|equipo|actividad/i, Icon: Users, color: "var(--nf-info-text)", background: "#ecfdf5" },
] as const;
