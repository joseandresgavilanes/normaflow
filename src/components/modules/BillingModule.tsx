...
export default function BillingModule({ liveData }: { liveData?: BillingPayload }) {
  ...
  return <div>
    ...
    {live && trialActive && <Card style={{ padding: 17, marginBottom: 18, borderColor: "var(--nf-primary)", background: "var(--nf-primary-subtle)" }}><strong style={{ color: "#3344bd" }}>Trial activo · {liveData.trialDaysRemaining ?? 0} días restantes</strong><span style={{ display: "block", marginTop: 5, color: "var(--nf-text-secondary)", fontSize: 13 }}>Prueba NormaFlow sin tarjeta. Elige un plan cuando quieras conservar el acceso después del trial.</span></Card>}
