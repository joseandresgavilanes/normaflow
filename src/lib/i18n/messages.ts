...
export const messages = {
  es: {
    ...
    "auth.signup.sessionActive": "Ya has iniciado sesión como {email}. Para dar de alta otra empresa, cierra la sesión primero.",
    "auth.signup.signOutFirst": "Cerrar sesión y registrar otra empresa",
    "auth.signup.signOutLoading": "Cerrando sesión…",
    ...
    "error.orgSwitchFailed": "No se pudo cambiar de organización.",
    "error.signupAlreadyMember": "Tu cuenta ya pertenece a {organization}, así que no se creó ninguna organización nueva. Cierra la sesión y regístrate con otro correo.",
  ...
  en: {
    ...
    "auth.signup.sessionActive": "You are already signed in as {email}. Sign out first to register a different company.",
    "auth.signup.signOutFirst": "Sign out and register another company",
    "auth.signup.signOutLoading": "Signing out…",
    ...
    "error.orgSwitchFailed": "Could not switch organization.",
    "error.signupAlreadyMember": "Your account already belongs to {organization}, so no new organization was created. Sign out and register with a different email.",
  ...
  "pt-BR": {
    ...
    "auth.signup.sessionActive": "Você já entrou como {email}. Saia da sessão antes de cadastrar outra empresa.",
    "auth.signup.signOutFirst": "Sair e cadastrar outra empresa",
    "auth.signup.signOutLoading": "Saindo…",
    ...
    "error.orgSwitchFailed": "Não foi possível trocar de organização.",
    "error.signupAlreadyMember": "Sua conta já pertence a {organization}, portanto nenhuma organização nova foi criada. Saia e cadastre-se com outro e-mail.",
