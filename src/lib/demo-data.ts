...
export const DEMO_AUDITS = [
  { id: "a1", title: "Auditoría Interna ISO 9001 — Q2 2025", type: "INTERNAL", standard: "ISO 9001", status: "COMPLETED", date: "2025-05-20", findings: 1, criticals: 0, progress: 100, auditor: "Carlos Méndez", scope: "Cláusulas 4 a 10", objectives: "Verificar el mantenimiento del SGC y preparación para la auditoría de vigilancia" },
  { id: "a2", title: "Auditoría de Seguridad ISO 27001 — Semestral", type: "INTERNAL", standard: "ISO 27001", status: "IN_PROGRESS", date: "2025-06-15", findings: 1, criticals: 1, progress: 65, auditor: "Ana García", scope: "Controles Anexo A: A.5 a A.12", objectives: "Evaluar la implementación de controles técnicos y organizativos" },
...
export const DEMO_NONCONFORMITIES = [
  { id: "nc1", code: "NC-001", title: "Documentación de proceso de producción desactualizada desde hace 8 meses", source: "INTERNAL_AUDIT", severity: "MAJOR", status: "IN_PROGRESS", owner: "José López", due: "2025-07-15", auditId: "a1", auditTitle: "Auditoría Interna ISO 9001 — Q2 2025", clause: "8.5", rootCause: "Ausencia de proceso formal de revisión periódica de documentos de proceso. El responsable de actualización no estaba designado formalmente en el procedimiento SGC-PRO-001.", correction: "Actualizar documentación de los 3 procesos afectados", correctiveAction: "Incluir responsable explícito en procedimiento de control documental y programar revisiones semestrales en calendario." },
