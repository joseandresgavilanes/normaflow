...
import { getSafetyPayload } from "@/lib/safety/queries";
import { isAuthorizationError } from "@/lib/permissions/server";

export const metadata = { title: "Seguridad y Salud | NormaFlow" };
...
export default async function SafetyPage() {
  ...
  return <SafetyClient initial={demoPayload()} demo />;
}

async function renderLive() {
  try {
    return <SafetyClient initial={await getSafetyPayload()} />;
  } catch (error) {
...
function demoPayload(): Awaited<ReturnType<typeof getSafetyPayload>> {
  return {
    ...
    hazards: [
      { id: "d-h1", code: "PEL-0001", activity: "Trabajo en altura", task: "Montaje", hazard: "Caída de altura", category: "MECHANICAL", exposedWorkers: 4, inherentLevel: "CRITICAL", residualLevel: "HIGH", acceptability: "NOT_ACCEPTABLE" },
      { id: "d-h2", code: "PEL-0002", activity: "Soldadura", task: "Fabricación", hazard: "Exposición a humos", category: "CHEMICAL", exposedWorkers: 3, inherentLevel: "HIGH", residualLevel: "MEDIUM", acceptability: "TOLERABLE" },
    ],
    incidents: [
    ...
    surveillance: [{ id: "d-s1", code: "VS-0001", workerName: "Ana R.", fitness: "FIT_WITH_RESTRICTIONS", nextReviewDate: new Date(Date.now() + 86400000 * 120) }],
    ...
    summary: { hazards: 2, criticalRisks: 1, openIncidents: 2, nearMisses: 7, permits: 1, overdueActions: 2 },
  };
}
